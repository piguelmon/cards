...
module.exports = {
    blackCard: function (callback) {
        ...
        for(var i = 0; i < cards.blackCards.lenght; i++){
            if(!cards.blackCards[i].picked){
                return callback(null, cards.blackCards[i]);
            }
        }
    },
    whiteCards: function (count, callback) {
        ...
        for(var i = 0; i < cards.blackCards.lenght; i++){
            if(!white_cards_used[cards.whiteCards[i]]){
                white_cards_used[cards.whiteCards[i]] = 1;
                return callback(null, cards.blackCards[i]);
            }
        }
    }
